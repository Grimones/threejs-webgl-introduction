...
var SplitViewCodeSlide = function (_React$Component) {
  _inherits(SplitViewCodeSlide, _React$Component);

  function SplitViewCodeSlide() {
    var _ref;

    var _temp, _this, _ret;

    _classCallCheck(this, SplitViewCodeSlide);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SplitViewCodeSlide.__proto__ || Object.getPrototypeOf(SplitViewCodeSlide)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      if (active !== null) {
        ...
        if (_this.props.getStep) {
          _this.props.getStep(active, _this.props.ranges.length);
        }
        _this.goTo(active);
      }
  ...
  _createClass(SplitViewCodeSlide, [{
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              'pre',
              { ref: 'container', style: _extends({}, style, { height: window.innerHeight }) },
              React.createElement(
                'code',
          ...
          React.createElement(
            ...
            React.createElement(
              'pre',
              { style: _extends({}, style, { height: window.innerHeight }) },
  ...
  return SplitViewCodeSlide;
}(React.Component);

SplitViewCodeSlide.propTypes = {
...
SplitViewCodeSlide.defaultProps = {
  showLineNumbers: true
};
SplitViewCodeSlide.contextTypes = {
  store: React.PropTypes.object.isRequired,
  updateNotes: React.PropTypes.func
};


module.exports = SplitViewCodeSlide;