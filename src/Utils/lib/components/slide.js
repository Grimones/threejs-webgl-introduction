...
var Slide = (0, _transitionable.Transitionable)(_class = (0, _radium2.default)(_class = (_class2 = function (_React$PureComponent) {
  ...
  function Slide(props) {
    ...
    _this.stepCounter = (0, _stepCounter2.default)();
    return _this;
  }
  ...
  Slide.prototype.componentDidUpdate = function componentDidUpdate() {
    var stepCount = this.stepCounter.getCount();
    if (this.props.getAppearStep) {
      if (stepCount.index === this.props.slideIndex) {
        this.props.getAppearStep(stepCount);
      }
    }
  };
